...
<div class="eventos-registro">
    ...
    <aside class="registro">
                ...
                <!-- Formulario para registrar las elecciones del usuario en la base de datos -->
                <form id="registro" class="formulario">
                            <div class="formulario__campo">
                                <input type="submit" value="Registrarme" class="formulario__submit formulario__submit--registrar">
                            </div>
                </form>
    </aside>
</div>