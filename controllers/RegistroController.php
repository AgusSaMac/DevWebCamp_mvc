...
class RegistroController {
    public static function crear(Router $router) {
        ...
        // Verificar que el usuario ya haya realizado el pago
    ...
    public static function conferencias(Router $router) {
        ...
        //Formateo de eventos para mostrar en la vista
        ...
        //Obtener los regalos para mostrarlos en la vista
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // se resta un lugar al evento
            foreach($eventos_array as $evento) {
                $evento->disponibles -= 1;
                $evento->guardar();

                // Almacenar el registro (muchos a muchos, usando una tabla pivote)
                $datos = [
